...
from src.checkers.image_analyzer_api_checker import ImageAnalyzerApiChecker
...
checkers = [
    ...
    ImageAnalyzerApiChecker(
        type=FraudCheckerType.IMAGE, api_endpoint="http://127.0.0.1:8080/analyze"
    ),
]
